#!/usr/bin/env bash
# Obtiene un access token de Microsoft Entra ID mediante Device Code Flow.
# Uso:   ./get-token.sh
# Requiere .env (copia de .env.example) con AZURE_TENANT_ID, AZURE_CLIENT_ID y AZURE_SCOPE.
set -euo pipefail
